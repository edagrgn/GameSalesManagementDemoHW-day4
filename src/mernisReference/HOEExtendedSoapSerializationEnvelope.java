...
public class HOEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HOEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HOEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HOEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HOEDateTimeConverter dateTimeConverter = new HOEStandardDateTimeConverter();

    public HOEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HOEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HOEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HOEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HOEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HOEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
