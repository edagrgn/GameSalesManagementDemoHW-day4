...
public class HOEKPSPublicSoap
{
    ...
    public HOEKPSPublicSoap(){}

    public HOEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HOEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HOEExtendedSoapSerializationEnvelope envelope= new HOEExtendedSoapSerializationEnvelope(HOEExtendedSoapSerializationEnvelope.VER11);
